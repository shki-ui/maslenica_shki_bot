...
async def send_now(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """⚠️ МГНОВЕННАЯ отправка сообщения за 18 февраля ВСЕМ пользователям"""
    
    # Твой USER ID (узнай у @userinfobot)
    YOUR_USER_ID = 1453183670  # ← ЗАМЕНИ НА СВОЙ!
    ...
    await update.message.reply_text("⏳ Начинаю рассылку всем пользователям...")
    ...
    # Текст и кнопка (как в send_game_1)
    text = """
 ✨*Среда — «Лакомка»*
...
Среда считалась самым вкусным днём Масленицы. Хозяйки накрывали богатые столы с блинами, мёдом, вареньем и сметаной. По традиции тёщи приглашали зятьёв в гости и угощали их самыми лучшими блюдами, показывая своё гостеприимство и добрые отношения.
    ...
    for chat_id in user_ids:
        try:
            ...
            sent += 1
            # Маленькая пауза, чтобы не забанили за спам
